jQuery(document).ready(function ($) {
    ...
    $('.predefined a').click(function(e) {
		...
		/* Set Image logo */
		$('#zo-header-logo.logo-7 img').attr('src', ZOPreset.theme_url + '/inc/selector/images/logo/logo-' +preset+ '.png');
		$('#zo-header-logo.logo-default img').attr('src', ZOPreset.theme_url + '/inc/selector/images/logo/logo-default-' +preset+ '.png');
		$('#zo-footer-top.footer-default img').attr('src', ZOPreset.theme_url + '/inc/selector/images/logo/logo-' +preset+ '.png');
		$('#zo-footer-top.footer-1 img').attr('src', ZOPreset.theme_url + '/inc/selector/images/logo/flogo-' +preset+ '.png');
