jQuery(document).ready(function ($) {
	 ...
	 * Audio play
	 */
	$('.zo-blog-audio .play-button').on('click', function (e) {
		var parent = $(this).closest('.zo-blog-audio');
	...
	if (zo_parallax.length > 0 && ZOOptions.parallax == '1') {
	...
	if (zo_header_parallax.length > 0 && ZOOptions.page_title_parallax == '1' && ZOOptions.parallax == '1') {
	...
	$('.zo-post-like').on('click', function () {
		"use strict";
		/* get post id. */
		var bt_like = $(this);
