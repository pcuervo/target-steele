            ...
            for ($i = 1; $i <= $columns; $i++) : ?>
                ...
                <div class="zo-fancybox-item <?php echo esc_attr($atts['item_class']); ?>">
	                <div class="zo-fancybox-inner">
		                ...
		                <?php else : ?>
			                <div class="zo-fancybox-icon zo-fancybox-font" style="color: <?php echo esc_attr($zo_fancybox_icon_color); ?>;">
		                ...
		                <?php if($atts['button_text']!=''):?>
			                <div class="zo-fancybox-readmore">
				                <?php $class_btn = ($atts['button_type']=='button') ? 'btn btn-gray btn-transparent' : ''; ?>
				                <a href="<?php echo esc_url($button_link);?>" class="<?php echo esc_attr($class_btn);?>"><span><?php echo esc_attr($atts['button_text']);?></span></a>
			                </div>
		                <?php endif;?>
	                </div>
                </div>
