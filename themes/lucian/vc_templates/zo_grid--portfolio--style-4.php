...
$zo_image_style = isset($atts['zo_img_style']) ? $atts['zo_img_style'] : '';
            ...
            <div class="zo-portfolio-item <?php echo esc_attr($atts['item_class']);?>" data-groups='[<?php echo implode(',', $groups);?>]'>
                <div class="zo-portfolio-inner">
                    ...
                    if(has_post_thumbnail()) {
	                    if( $zo_image_style == 'full' ) {
		                    the_post_thumbnail($zo_image_style);
	                    }
	                    else {
		                    echo zo_post_thumbnail(490, 375, true);
	                    }
                    }
                    ?>
                    <div class="zo-portfolio-overlay">
						<a class="readmore" href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><?php the_title(); ?></a>
                    </div>
                </div>
