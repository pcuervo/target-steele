<div class="zo-progress-wraper <?php echo esc_attr($atts['template']); ?>"
    ...
    <div class="zo-progress-body">
        ...
        <div id="zo-progress-<?php echo esc_attr($uqid); ?>" class="<?php echo esc_attr($item_class); ?>">
            ...
            <div class="zo-progress-main <?php if ($zo_progress_custom_icon) {
                ...
                <?php if ($show_value): ?>
                    <span class="zo-progress-bar-counter-wrap"><strong class="zo-process-bar-counter"><?php echo esc_attr($value);?></strong><?php echo esc_attr($value_suffix);?></span>
                <?php endif; ?>
            </div>
        </div>
    </div>
