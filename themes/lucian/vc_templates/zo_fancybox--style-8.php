                    ...
                    <div class="zo-fancybox-inner">
                        <div class="zo-fancybox-header">
                            ...
                            <?php if($atts['button_text']!=''):?>
                                <div class="zo-fancybox-overlay">
                                    <?php $class_btn = ($atts['button_type']=='button') ? 'btn btn-large' : ''; ?>
                                    <a href="<?php echo esc_url($button_link);?>" class="<?php echo esc_attr($class_btn);?>"><span><?php echo esc_attr($atts['button_text']);?></span> <i class="fa fa-arrow-right"></i></a>
                                </div>
                            <?php endif;?>
                        </div>
                        <?php if ($title): ?>
