...
$zo_fancybox_title_line = isset($atts['zo_fancybox_title_line']) ? $atts['zo_fancybox_title_line'] : '';
$zo_fancybox_style = isset($atts['zo_fancybox_style']) ? $atts['zo_fancybox_style'] : '';
$zo_fancybox_align = isset($atts['zo_fancybox_align']) ? $atts['zo_fancybox_align'] : '';
$zo_fancybox_hover = isset($atts['zo_fancybox_hover']) ? $atts['zo_fancybox_hover'] : '';
...
?>
<div class="zo-fancyboxes-wraper <?php echo esc_attr($zo_fancybox_style); ?> <?php echo esc_attr($zo_fancybox_title_line); ?> <?php echo esc_attr($zo_fancybox_align); ?> <?php echo esc_attr($zo_fancybox_hover); ?> <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">
    <?php if($atts['title']!=''):?>
